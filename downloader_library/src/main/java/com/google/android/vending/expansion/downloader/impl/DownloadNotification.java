...
public class DownloadNotification implements IDownloaderClient {
    ...
    private Notification.Builder mCurrentNotification2;
...
//                    mContentIntent);
            ...
            mCurrentNotification2
                    .setTicker(mLabel + ": " + mCurrentText)
                    .setSmallIcon(iconResource);

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                mCurrentNotification = mCurrentNotification2.build();
            }
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                mNotification = mNotification2.build();
            }
...
//            mNotification.setLatestEventInfo(mContext, mLabel, mCurrentText, mContentIntent);
    ...
    DownloadNotification(Context ctx, CharSequence applicationLabel) {
        ...
        mNotification2 = new Notification.Builder(ctx);
        mCurrentNotification2 = mNotification2;
